...
export default function EmployeeProfilePanel() {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-72 bg-white dark:bg-gray-800 shadow-2xl z-50 transform transition-transform duration-300 flex flex-col ${open ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex items-center justify-between p-4 border-b">
          <span className="font-bold text-base">{t.myProfile}</span>
          <button onClick={() => setOpen(false)} className="p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700">
        ...
        <div className="flex-1 p-6 flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            ...
            <Badge className="mt-1 bg-green-100 text-green-700 hover:bg-green-100">{currentUser?.role || t.employee}</Badge>
          </div>
