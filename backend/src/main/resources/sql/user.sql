...
MERGE INTO PEOPLE_LOG target
USING (
    SELECT 'V1StGXR8_Z5jdHi6B-myT' AS STORE_ID, 'CAM-001' AS CAMERA_ID,
           TO_TIMESTAMP('2026-07-09 08:00:00', 'YYYY-MM-DD HH24:MI:SS') AS RECORD_TIME,
           4 AS PEOPLE_COUNT
    FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), 8 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 10:00:00', 'YYYY-MM-DD HH24:MI:SS'), 14 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), 22 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 12:00:00', 'YYYY-MM-DD HH24:MI:SS'), 38 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 13:00:00', 'YYYY-MM-DD HH24:MI:SS'), 42 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 14:00:00', 'YYYY-MM-DD HH24:MI:SS'), 29 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 15:00:00', 'YYYY-MM-DD HH24:MI:SS'), 24 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 16:00:00', 'YYYY-MM-DD HH24:MI:SS'), 31 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 17:00:00', 'YYYY-MM-DD HH24:MI:SS'), 45 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 18:00:00', 'YYYY-MM-DD HH24:MI:SS'), 63 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 19:00:00', 'YYYY-MM-DD HH24:MI:SS'), 71 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 20:00:00', 'YYYY-MM-DD HH24:MI:SS'), 54 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 21:00:00', 'YYYY-MM-DD HH24:MI:SS'), 28 FROM DUAL
    UNION ALL SELECT 'V1StGXR8_Z5jdHi6B-myT', 'CAM-001', TO_TIMESTAMP('2026-07-09 22:00:00', 'YYYY-MM-DD HH24:MI:SS'), 12 FROM DUAL
) source
ON (
    target.STORE_ID = source.STORE_ID
        AND target.CAMERA_ID = source.CAMERA_ID
